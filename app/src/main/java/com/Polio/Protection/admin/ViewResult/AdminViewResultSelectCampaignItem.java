...
public class AdminViewResultSelectCampaignItem {

    String campaign_key, campaign_id, campaign_star_date, campaign_end_date;
    int campaign_no;

    public AdminViewResultSelectCampaignItem(String campaign_key, String campaign_id, String campaign_star_date, String campaign_end_date, int campaign_no) {
