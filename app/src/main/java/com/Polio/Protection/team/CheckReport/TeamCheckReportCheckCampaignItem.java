...
public class TeamCheckReportCheckCampaignItem {

    String campaign_key, campaign_id, campaign_star_date, campaign_end_date;
    int campaign_no;

    public TeamCheckReportCheckCampaignItem(String campaign_key, int campaign_no, String campaign_id, String campaign_star_date, String campaign_end_date) {
