...
public class TeamCheckReportChildren extends AppCompatActivity {

    TextView Child_name, father_name, father_cnic, child_date_of_birth, child_gender, child_mark_date, child_mark_time, child_address;
    String name_Child, name_father, cnic_father, date_of_birth_child, gender_child, mark_date_child, mark_time_child, address_child, picture_child;
    String child_key, campaign_key, date_and_time, location_latitude, location_longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.team_check_report_children);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() != null) {
                    ...
                    fetch_father_info(date_and_time, picture_child, cnic_father, child_key);
                } else {
    ...
    private void fetch_father_info(final String date_and_time, final String picture_child, final String cnic_father, final String child_key) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() != null) {
                    ...
                    fetch_child_info(date_and_time, picture_child, cnic_father, child_key, name_father, address_child);
                } else {
                    pr.setVisibility(View.INVISIBLE);
                    Toast.makeText(getApplicationContext(), "Something was Wrong !!!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void fetch_child_info(final String date_and_time, final String picture_child, final String cnic_father, final String child_key, final String name_father, final String address_child) {
    ...
    private void on_internet_dailog() {
        ...
        new AlertDialog.Builder(TeamCheckReportChildren.this)
