...
public class TeamCheckReportItem {

    String children_name, children_key, father_cnic, mark_date, mark_time, campaign_key;
    int children_no;

    public TeamCheckReportItem(int children_no, String children_name, String children_key, String father_cnic, String mark_date,  String mark_time, String campaign_key) {
